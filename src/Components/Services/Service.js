  ...
  <section className="work" id="service">
    <div className="work-content-left">
      ...
      <p className="work-description">
        Nous réalisations des applications natives et cross-platform Android, iOS (Apple) web et web mobile, webapp et
        back-office.
      </p>
      <div className="work-button">
        <Link to="/Contact">
          ...
          <p className="work-button-text">
            Get in touch with us <AiOutlineArrowRight className="work-icons" />{' '}
          </p>
        </Link>
      </div>
    </div>
    <div className="work-content-right">
      <div className="card2">
        ...
        <p className="work-description">
          Conception d’applications mobiles sur-mesure iOS et Android, natives et cross-plateformes.
        </p>
      </div>
      <div className="card2">
        <div className="work-icon">
        ...
        <p className="work-description">Euismod faucibus turpis eu gravida mi. Pellentesque et velit aliquam .</p>
      </div>
      <div className="card2">
        <div className="work-icon">
          {' '}
